...
class StoryState extends FlxState {
    ...
    override public function create(): Void {
        ...
        _txtLine1.color = FlxColor.WHITE;
        ...
        _txtLine2.color = FlxColor.WHITE;
        ...
        _txtLine3.color = FlxColor.WHITE;
        ...
        _txtLine4.color = FlxColor.WHITE;
        ...
        _txtLine5.color = FlxColor.WHITE;
        ...
        _txtLine6.color = FlxColor.WHITE;
        ...
        _txtLine7.color = FlxColor.WHITE;
