...
@:dox(hide) class ApplicationMain {
	...
	public static function main () {
		...
		lime.system.System.__registerEntryPoint ("GameDev1P1", create);
		
		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed ("GameDev1P1", null, 640, 480);
		#end
		#else
		create (null);
		#end
	...
	public static function create (config):Void {
		...
		app.meta["file"] = "GameDev1P1";
		app.meta["name"] = "GameDev1P1";
